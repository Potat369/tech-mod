...
public class BlockTagProvider extends FabricTagProvider<Block> {
    ...
    protected void configure(RegistryWrapper.WrapperLookup registries) {
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE).add(ModBlocks.ORE_MINER, ModBlocks.ORE_SCANNER);
        getOrCreateTagBuilder(BlockTags.NEEDS_IRON_TOOL).add(ModBlocks.ORE_MINER, ModBlocks.ORE_SCANNER);
    }
}
